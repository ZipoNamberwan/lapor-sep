            ...
            <div class="card-wrapper">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="mb-1">Report Progres Editing Coding [3500] Provinsi Jawa Timur</h3>
                            ...
                            <div class="table-responsive">
                                <table class="table" id="datatable-id" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><a href="/report/edcod/kec/{{$reg->regency_long_code}}">[{{$reg->regency_short_code}}] {{$reg->regency_name}}</a></td>
