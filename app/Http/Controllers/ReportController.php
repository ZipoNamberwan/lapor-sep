...
class ReportController extends Controller
{
    ...
    function reportKab(Request $request)
    {
        $data = ReportRegency::orderBy('regency_short_code')->get();
        foreach($data as $dt){
            $dt->short_code = $dt->regency_short_code;
            $dt->name = $dt->regency_name;
        }
        return json_encode([
            "draw" => $request->draw,
        ...
        return json_encode(ReportRegency::orderBy('regency_short_code')->get());
    }
